...
import org.apache.httpclient.client.methods.HttpUriRequest;
import org.apache.httpclient.client.protocol.HttpClientContext;
import org.apache.httpclient.client.protocol.RequestClientConnControl;
import org.apache.httpclient.client.utils.URIUtils;
...
import static org.apache.httpclient.client.utils.URIUtils.DROP_FRAGMENT;
import static org.apache.httpclient.client.utils.URIUtils.DROP_FRAGMENT_AND_NORMALIZE;
...
//    private final Log log = LogFactory.getLog(getClass());
    ...
    public CloseableHttpResponse execute(
        ...
        final ConnectionHolder releaseTrigger = new ConnectionHolder(
//                log,
                connManager, managedConn);
        try {
            if (execAware != null) {
                if (execAware.isAborted()) {
